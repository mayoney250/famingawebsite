...
// Force our content instead of using database content - this is critical!
...
<main class="py-16 px-6">
    <div class="container mx-auto max-w-4xl">
        ...
        <div style="background: #000; color: #0f0; padding: 10px; margin: 10px 0; font-family: monospace; border: 2px solid #0f0;">
            <strong>DEBUG:</strong> Using template-privacy-policy.php | 
