...
<div id="primary" class="content-area py-16 px-6">
    <main id="main" class="site-main container mx-auto max-w-4xl">
        ...
        <?php if ( have_posts() ) : ?>
            ...
            <header class="mb-12">
                <div class="author-box bg-[#0a2c0a] rounded-lg p-8 shadow-lg border border-[#526700] border-opacity-30 flex items-center">
                    ...
                    <div class="author-info">
                        ...
                        if ( $author_description ) {
                            echo '<div class="text-lg text-gray-300">' . wp_kses_post( $author_description ) . '</div>';
                        }
                        ?>
                    </div>
                </div>
            ...
            <h2 class="text-3xl font-bold text-white mb-8 text-center">Posts by <?php echo esc_html(get_the_author()); ?></h2>
